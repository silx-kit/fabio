...
CASES = [
    ...
    ( 1     , 'adsc_or_OXD_HiPiC' , 'mb_LP_1_001.img' ),
    ( 2     , 'adsc_or_OXD_HiPiC' , 'mb_LP_1_002.img.gz' ),
    ( 3     , 'adsc_or_OXD_HiPiC' , 'mb_LP_1_003.img.bz2' ),
    ( 3     , 'adsc_or_OXD_HiPiC' , os.path.join("data", 'mb_LP_1_003.img.bz2' )),
    ]
