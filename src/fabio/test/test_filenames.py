...
MORE_CASES = [
    ...
    (
        ...
        os.path.join("images/sampledir", "P33S670002.edf"),
        670003,
    ),
    (
        os.path.join("images/P33S67", "P33S670003.edf"),
        os.path.join("images/P33S67", "P33S670002.edf"),
        670003,
    ),
...
class TestFilenames(unittest.TestCase):
    ...
    def test_many_cases(self):
        ...
        for num, typ, name in CASES:
            ...
            self.assertEqual(
                num, obj.num, name + " num=" + str(num) + " != obj.num=" + str(obj.num)
            )
            self.assertEqual(
                typ, "_or_".join(obj.format), name + " " + "_or_".join(obj.format)
            )
